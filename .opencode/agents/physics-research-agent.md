...
- `@.opencode/extensions/formal/context/project/physics/README.md` - Physics context index (load FIRST)
...
- `@.opencode/extensions/formal/context/project/math/topology/topological-spaces.md` - Topological foundations
- `@.opencode/extensions/formal/context/project/math/order-theory/partial-orders.md` - Well-foundedness
