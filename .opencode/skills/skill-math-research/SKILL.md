...
description: Research mathematical foundation tasks using domain context and codebase exploration. Invoke for math-language research involving algebra, lattice theory, order theory, topology, and category theory.
...
Thin wrapper that delegates mathematical foundations research to `math-research-agent` subagent.
...
- Search codebase (Lean modules, LaTeX chapters) for existing patterns
...
- Found existing patterns in Lean modules and Mathlib
- Loaded domain context for lattice theory and order theory
...
- Loaded lattice-theory and quantales context
