...
The subagent will:
- Load domain context files from `.opencode/context/project/latex/`
- Search codebase (LaTeX chapters, style files) for existing patterns
...
- Found existing patterns in LaTeX chapters and style files
