...
description: Research mathematical logic tasks using domain context and codebase exploration. Invoke for logic-language research involving modal logic, temporal logic, mereology, topology, and related mathematical foundations.
...
- Research involves modal logic, temporal logic, mereology, topology, or general mathematics
...
- Search codebase (LaTeX chapters, Lean modules) for existing patterns
...
- Found existing patterns in LaTeX chapters and Lean modules
- Loaded domain context for modal/temporal logic
...
- Found patterns in 3 LaTeX chapters before timeout
