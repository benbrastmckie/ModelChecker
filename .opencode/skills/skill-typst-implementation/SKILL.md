...
#   - .opencode/context/project/typst/README.md
#   - .opencode/context/project/typst/standards/typst-style-guide.md
#   - .opencode/context/project/typst/standards/notation-conventions.md
#   - .opencode/context/project/typst/standards/document-structure.md
#   - .opencode/context/project/typst/patterns/theorem-environments.md
#   - .opencode/context/project/typst/patterns/cross-references.md
#   - .opencode/context/project/typst/templates/chapter-template.md
#   - .opencode/context/project/typst/tools/compilation-guide.md
...
plan_file=$(ls -1 "specs/$(printf '%03d' ${task_number})_${project_name}/plans/implementation-"*.md 2>/dev/null | sort -V | tail -1)
...
```json
{
  ...
  "plan_path": "specs/{OC_NNN}_{SLUG}/plans/implementation-{NNN}.md",
...
Agents live in `.opencode/agent/`, not `.opencode/skills/`.
...
Co-Authored-By: OpenCode <noreply@opencode.ai>" || echo "Warning: Commit failed but implementation completed"
fi
...
**Note**: Per-phase commits are handled by the implementation subagent during phase execution. This final commit captures any remaining changes after all phases complete.
