...
- `@.opencode/context/project/typst/README.md` - Typst context index (load FIRST if exists)
...
context_gaps = [
  {
    ...
    "recommended_file": "relative path within .opencode/context/project/typst/",
...
**Target Location**: .opencode/context/project/typst/{directory}/{filename}
```
...
**Target File**: .opencode/context/project/typst/{path}
```
