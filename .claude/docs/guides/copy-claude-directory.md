...
- **Specialized Skills**: Language-specific agents for Python/Z3 development, general research, and implementation
...
# Clone the ModelChecker repository
git clone https://github.com/benbrastmckie/ModelChecker.git

# Copy .claude/ to your project (replace YOUR_PROJECT_PATH)
cp -r ModelChecker/.claude YOUR_PROJECT_PATH/
...
cd /tmp
git clone https://github.com/benbrastmckie/ModelChecker.git
cp -r ModelChecker/.claude ~/Documents/Projects/my-project/
rm -rf ModelChecker
```
...
git clone --filter=blob:none --sparse https://github.com/benbrastmckie/ModelChecker.git
...
# Copy .claude/ to your project (replace YOUR_PROJECT_PATH)
Copy-Item -Recurse ModelChecker\.claude YOUR_PROJECT_PATH\

# Clean up
Remove-Item -Recurse -Force ModelChecker
```
...
cd $env:TEMP
git clone https://github.com/benbrastmckie/ModelChecker.git
Copy-Item -Recurse ModelChecker\.claude C:\Users\YourName\Projects\my-project\
Remove-Item -Recurse -Force ModelChecker
```
...
```
Please clone the ModelChecker repository from https://github.com/benbrastmckie/ModelChecker.git
