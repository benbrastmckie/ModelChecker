...
\begin{enumerate}
  ...
  % \item[\it Atomic States:] A state which includes exactly one occurrence of 1 may be said to be \textit{atomic} where this corresponds to some specific way of being, e.g., the cat is on the mat, the ball weighs 20g, or .
...
\begin{enumerate}
  ...
  % \item[\it Cardinality:] Sets of sentences are ranked by their cardinality.
