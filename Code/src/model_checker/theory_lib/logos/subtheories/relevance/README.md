...
```bash
# Run all relevance subtheory tests
python test_package.py --components logos.subtheories.relevance

# Run specific test files
python -m pytest src/model_checker/theory_lib/logos/subtheories/relevance/tests/
```
