...
This module implements the SK exclusion operator strategy with proper extended_verify method.
"""
...
class SK_ExclusionOperator(syntactic.Operator):
...
# Create the operator collection with SK exclusion operator
