...
# OLD Exclusion (now using local files)
...
example_range = {
    ...
    # "No Gluts" : GLUTS_example, # theorem
    # "EX_CM_1" : EX_CM_1_example, # countermodel


    # # Classical Negation Theorems (All should hold)

    "Double Negation Introduction" : DN_INTRO_example, # true conclusion
    # "Double Negation Elimination" : DN_ELIM_example, # countermodel
    "Triple Negation Entailment" : TN_ENTAIL_example, # false premise
    "Quadruple Negation Entailment" : QN_ENTAIL_example, # true conclusion
    # "Disjunctive Syllogism" : DISJ_SYLL_example,

    "Conjunctive DeMorgan's LR" : CONJ_DM_LR_example, # false premise
    "Conjunctive DeMorgan's RL" : CONJ_DM_RL_example, # false premise
    "Disjunctive DeMorgan's LR" : DISJ_DM_LR_example, # false premise
    ...
    "Triple Negation Identity" : TN_ID_example, # true conclusion
    # "Conjuctive DeMorgan's Identity" : CONJ_DM_ID_example, # theorem
    # "Disjunctive DeMorgan's Identity" : DISJ_DM_ID_example, # theorem
