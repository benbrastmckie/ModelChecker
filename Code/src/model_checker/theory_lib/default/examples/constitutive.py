"""
Constitutive Examples Module for Default Theory

This module provides constitutive-specific examples for the unified semantics,
...
constitutive_th_examples = {
    ...
    "CL_TH_9": CL_TH_9_example,
    "CL_TH_10": CL_TH_10_example,
