...
class LogosSemantics(SemanticDefaults):
    ...
    def __init__(self, combined_settings=None, operator_registry=None, **kwargs):
        ...
        self.is_alternative = z3.Function("is_alternative", z3.BitVecSort(self.N), z3.BitVecSort(self.N), z3.BitVecSort(self.N), z3.BoolSort())
        ...
        is_alternative_constraint = ForAll(
            [u, y, w],
            z3.And(
                z3.Implies(self.is_alternative(u, y, w), z3.And(
            self.is_world(u),
            self.is_part_of(y, u),
            Exists(z, z3.And(self.is_part_of(z, u), self.max_compatible_part(z, w, y))),
        )),
